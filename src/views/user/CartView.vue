...
<template>
  <UserLayout>
    <h1 class="text-3xl font-bold p-5" >Shopping Cart</h1>
    ...
    <div class="flex">
      ...
      <div class="flex-auto w-32 bg-slate-200 p-4">
        <div class="text-xl font-bold">Oder Summary</div>
        <div class="my-4 divide-y divide-black">
          ...
          <RouterLink :to="{name: 'checkout'}" class="btn btn-accent w-full mt-4">
            ชำระเงิน
          </RouterLink>
        </div>
